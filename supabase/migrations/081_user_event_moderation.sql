-- Migration 081: User Event Moderation
--
-- Updates filter_explore_items and count_filtered_explore_items RPCs so that
-- creators can see their own quarantined/rejected events in the explore feed.
-- Previously the review_status gate excluded all non-approved items regardless
-- of authorship.
--
-- Change:
...
-- ============================================================================
-- 2. Update count_filtered_explore_items
-- ============================================================================
