...
- Phase 3b mitigates *detection* (monitor jobs + GitHub Actions heartbeat). Proper fix: parameterized, env-aware cron definitions in migrations. Larger future item.
