...
- ⏳ **Migration 132 awaiting dashboard application** (CLI out of sync). Until applied, the 5 Phase 5.* cron jobs don't fire — manual invocation only.
- ⏳ **Google Places ingest broken for Warwick:** function returns 0 results after ~1-2 API calls, regardless of region. Last successful Potsdam GP ingest was earlier this year. Suspected API key/quota issue — needs Kevin to verify in Google Cloud console.
...
### Phase 5.* cron schedules — migration 132 (05/21/2026, awaiting dashboard apply)
