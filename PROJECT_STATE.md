...
**Last updated:** 08/07/2026 (Map redesign DONE on staging build #26 via OTA — Mapbox + emoji pins + de-clutter; the recurring "Invalid API key" root cause found & fixed; next step = merge the map branch to staging, then gated prod promotion)
**Owner:** Kevin Walter
